...
booster_df <- squire.page:::run_booster(
  ...
  time_period  = t,
  vaccine_booster_follow_up_coverage = rep(0, 17),
  vaccine_efficacy_infection = rep(0.5, 6),
  vaccine_efficacy_disease = rep(0.5, 6),
  vaccine_coverage_mat = matrix(0.8, ncol = 17, nrow = 1),
  rel_infectiousness_vaccinated =  matrix(
           rep(0.5, 6), ncol = 17, nrow = 6,
        ),
  dur_R = dur_R
) %>% 
  squire.page::nimue_format(var_select = c("infections", "deaths"))
...
With waning we would expect to see some minor difference as the booster only has
a single compartment to represent primary dose waning, though with the same overall rates
...
booster_df <- squire.page:::run_booster(
  ...
  time_period  = t,
  vaccine_booster_follow_up_coverage = rep(0, 17),
  vaccine_efficacy_infection = c(0.5, 0.5, 0, 0, 0, 0),
  vaccine_efficacy_disease = c(0.5, 0.5, 0, 0, 0, 0),
  vaccine_coverage_mat = matrix(0.8, ncol = 17, nrow = 1),
  rel_infectiousness_vaccinated =  matrix(
           c(0.5, 0.5, 1, 1, 1, 1), ncol = 17, nrow = 6,
        ),
  dur_V = rep(100, 3),
  dur_R = dur_R
) %>% 
...
booster_df <- squire.page:::run_booster(
  ...
  time_period  = t,
  vaccine_booster_follow_up_coverage = rep(0, 17),
  vaccine_efficacy_infection = c(ve_i_f, ve_i_s, 0, 0, 0, 0),
  vaccine_efficacy_disease = c(ve_d_f, ve_d_s, 0, 0, 0, 0),
  vaccine_coverage_mat = matrix(0.8, ncol = 17, nrow = 1),
  rel_infectiousness_vaccinated =  matrix(
           c(0.5, 0.5, 1, 1, 1, 1), ncol = 17, nrow = 6),
  dur_V = rep(100, 3),
...
booster_df <- squire.page:::run_booster(
  ...
  time_period  = t,
  vaccine_booster_follow_up_coverage = rep(0, 17),
  vaccine_efficacy_infection = c(ve_i_f, ve_i_s, 0, ve_i_b, ve_i_b_2, 0),
  vaccine_efficacy_disease = c(ve_d_f, ve_d_s, 0, ve_d_b, ve_d_b_2, 0),
  vaccine_coverage_mat = matrix(0.8, ncol = 17, nrow = 1),
  rel_infectiousness_vaccinated =  matrix(
