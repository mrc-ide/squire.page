...
nimue_booster_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("beta_set", "booster_doses", "D_0", "E1_0", "E2_0", "gamma_E",
             ...
             "rel_infectiousness_vaccinated", "runtime", "S_0",
             "second_doses", "tt_beta", "tt_dur_E", "tt_dur_get_mv_die",
             ...
             "tt_matrix", "tt_prob_hosp_multiplier",
...
nimue_booster_check_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "nimue_booster_check_rhs_dde",
      rhs_desolve = "nimue_booster_check_rhs_desolve",
      initmod_desolve = "nimue_booster_check_initmod_desolve",
      output_dde = "nimue_booster_check_output_dde"),
    dll = "squire.page",
    user = c("beta_set", "booster_doses", "D_0", "E1_0", "E2_0", "gamma_E",
             "gamma_get_mv_die", "gamma_get_mv_survive", "gamma_get_ox_die",
             "gamma_get_ox_survive", "gamma_ICase", "gamma_IMild",
    ...
    registration = function() {
      if (FALSE) {
        .C("nimue_booster_check_rhs_dde", package = "squire.page")
        .C("nimue_booster_check_rhs_desolve", package = "squire.page")
        .C("nimue_booster_check_initmod_desolve", package = "squire.page")
        .C("nimue_booster_check_output_dde", package = "squire.page")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("nimue_booster_check_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "squire.page")
    },

    update_metadata = function() {
      meta <- .Call("nimue_booster_check_metadata", private$ptr,
                    PACKAGE = "squire.page")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("nimue_booster_check_create", user, PACKAGE = "squire.page")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/nimue_booster_check.json", mustWork = TRUE,
                             package = "squire.page")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("nimue_booster_check_set_user", private$ptr, user, PACKAGE = "squire.page")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("nimue_booster_check_initial_conditions", private$ptr, t, PACKAGE = "squire.page")
    },

    rhs = function(t, y) {
      .Call("nimue_booster_check_rhs_r", private$ptr, t, y, PACKAGE = "squire.page")
    },
    ...
    contents = function() {
      .Call("nimue_booster_check_contents", private$ptr, PACKAGE = "squire.page")
    },
...
nimue_booster_check <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("nimue_booster_check")
  nimue_booster_check_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(nimue_booster_check) <- "odin_generator"
attr(nimue_booster_check, "generator") <- nimue_booster_check_
...
OLD_nimue_booster_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "OLD_nimue_booster_rhs_dde",
      rhs_desolve = "OLD_nimue_booster_rhs_desolve",
      initmod_desolve = "OLD_nimue_booster_initmod_desolve",
      output_dde = "OLD_nimue_booster_output_dde"),
    dll = "squire.page",
    user = c("beta_set", "booster_doses", "D_0", "E1_0", "E2_0", "gamma_E",
             "gamma_get_mv_die", "gamma_get_mv_survive", "gamma_get_ox_die",
             "gamma_get_ox_survive", "gamma_ICase", "gamma_IMild",
    ...
    registration = function() {
      if (FALSE) {
        .C("OLD_nimue_booster_rhs_dde", package = "squire.page")
        .C("OLD_nimue_booster_rhs_desolve", package = "squire.page")
        .C("OLD_nimue_booster_initmod_desolve", package = "squire.page")
        .C("OLD_nimue_booster_output_dde", package = "squire.page")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("OLD_nimue_booster_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "squire.page")
    },

    update_metadata = function() {
      meta <- .Call("OLD_nimue_booster_metadata", private$ptr,
                    PACKAGE = "squire.page")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("OLD_nimue_booster_create", user, PACKAGE = "squire.page")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/OLD_nimue_booster.json", mustWork = TRUE,
                             package = "squire.page")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("OLD_nimue_booster_set_user", private$ptr, user, PACKAGE = "squire.page")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("OLD_nimue_booster_initial_conditions", private$ptr, t, PACKAGE = "squire.page")
    },

    rhs = function(t, y) {
      .Call("OLD_nimue_booster_rhs_r", private$ptr, t, y, PACKAGE = "squire.page")
    },
    ...
    contents = function() {
      .Call("OLD_nimue_booster_contents", private$ptr, PACKAGE = "squire.page")
    },
...
OLD_nimue_booster <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("OLD_nimue_booster")
  OLD_nimue_booster_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(OLD_nimue_booster) <- "odin_generator"
attr(OLD_nimue_booster, "generator") <- OLD_nimue_booster_
